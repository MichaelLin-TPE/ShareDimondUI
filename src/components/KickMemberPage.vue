...
.km-icon {
  font-size: 2rem;
  filter: drop-shadow(0 0 8px rgba(var(--c-light-rgb), 0.45));
}
.km-title {
  margin: 0 0 4px;
  font-size: 1.5rem;
...
.km-stat.officer { border-color: rgba(var(--c-light-rgb), 0.4); }
.km-stat.officer .km-stat-num { color: var(--c-light); }
...
.km-card.officer::before { background: linear-gradient(90deg, var(--c-light), var(--c-deep)); }
...
.km-avatar.officer { background: linear-gradient(135deg, var(--c-light), var(--c-deep)); color: var(--c-on); }
...
.km-spinner {
  width: 38px;
  height: 38px;
  border: 3px solid rgba(var(--c-light-rgb), 0.2);
...
.km-modal__avatar.officer { background: linear-gradient(135deg, var(--c-light), var(--c-deep)); color: var(--c-on); }
