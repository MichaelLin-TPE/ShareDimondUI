...
export const AG_ITEMS: AgItem[] = [
  ...
  { name: '長劍', cat: 'weapon', slot: '單手劍', stat: '8 / 10', safe: 6, cls: '君主 騎士 黑妖 龍騎', from: '商店' },
  { name: '日本刀', cat: 'weapon', slot: '單手劍', stat: '10 / 8', safe: 6, cls: '君主 騎士 黑妖 龍騎', from: '怪物掉落' },
  { name: '雙手劍', cat: 'weapon', slot: '雙手劍', stat: '15 / 16', safe: 6, cls: '騎士 龍騎', from: '怪物掉落' },
  ...
  { name: '魔杖', cat: 'weapon', slot: '法杖', stat: '4 / 4', safe: 6, cls: '法師 幻術', from: '商店' },
  { name: '皮盔', cat: 'armor', slot: '頭盔', stat: 'AC −1', safe: 6, cls: '全職業', from: '商店' },
  { name: '鎖子甲', cat: 'armor', slot: '盔甲', stat: 'AC −5', safe: 6, cls: '君主 騎士 龍騎', from: '商店' },
  { name: '板甲', cat: 'armor', slot: '盔甲', stat: 'AC −7', safe: 6, cls: '騎士 龍騎', from: '怪物掉落' },
  { name: '精靈鏈甲', cat: 'armor', slot: '盔甲', stat: 'AC −6', safe: 6, cls: '妖精', from: '怪物掉落' },
  { name: '魔法長袍', cat: 'armor', slot: '盔甲', stat: 'AC −3', safe: 6, cls: '法師 幻術', from: '商店' },
  { name: '鐵盾', cat: 'armor', slot: '盾牌', stat: 'AC −3', safe: 6, cls: '君主 騎士 龍騎', from: '商店' },
