...
export const AG_CLASSES: AgClass[] = [
  { id: 'royal', name: '君主', latin: 'PRINCE', role: '血盟領袖 · 光環輔助', desc: '唯一能創血盟、發起攻城的職業。王族光環實裝後,站在隊伍裡就是加成。', stats: { str: 13, dex: 10, con: 10, wis: 11, cha: 13, int: 10 }, bonus: 8 },
  ...
  { id: 'dragon', name: '龍騎士', latin: 'DRAGON KNIGHT', role: '龍化 · 持續作戰', desc: '體質高、龍化形態耐打,適合長時間掛點與副本。', stats: { str: 13, dex: 11, con: 14, wis: 12, cha: 8, int: 11 }, bonus: 6 },
  { id: 'illusion', name: '幻術師', latin: 'ILLUSIONIST', role: '立方體 · 控場', desc: '魔力成長倍率最高,立方體與控場技能讓隊伍打得更輕鬆。', stats: { str: 11, dex: 10, con: 12, wis: 12, cha: 8, int: 12 }, bonus: 10 },
]
