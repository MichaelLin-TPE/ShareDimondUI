...
import { useAuction } from '@/composables/deposit.ts'
  ...
  <div class="deposit-container">
    <div class="deposit-card">
      ...
      <div class="field">
        ...
        <MemberSelect v-model="selectedMemberId" :members="memberList" placeholder="選擇審核者" />
      </div>
      ...
      <button class="submit-btn" @click="handleDeposit" :disabled="submitting">
