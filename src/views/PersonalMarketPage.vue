...
.listing-card.mine {
  ...
  background: linear-gradient(180deg, rgba(99, 102, 241, 0.08) 0%, rgba(22, 24, 34, 0.95) 100%);
}
.card-top {
  display: flex;
  justify-content: space-between;
...
.my-card.waitpay {
  ...
  background: linear-gradient(180deg, rgba(245, 158, 11, 0.08) 0%, rgba(22, 24, 34, 0.95) 100%);
}
.my-card.history {
  opacity: 0.78;
}
