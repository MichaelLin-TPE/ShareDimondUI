...
.stat-card.upcoming .stat-num { color: #fbbf24; }
...
.btn-respawn:hover { background: rgba(99,102,241,0.3); transform: translateY(-1px); }
.btn-edit {
...
.modal-bar.cyan { background: linear-gradient(90deg, #06b6d4, #6366f1); }
.modal-icon-lg {
  font-size: 2.8rem;
  text-align: center;
  margin-bottom: 12px;
